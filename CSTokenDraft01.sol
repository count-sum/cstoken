...
contract ERC20Token is StandardToken, Ownable {
    ...
    function ERC20Token() public {
        ...
        totalSupply     = totalCoin * 10**uint(decimals); // Total Supply of Coin with decimals
        balances[owner] = totalSupply;                    // Total Supply sent to Owner's Address
        exchangeRate    = 5000;                            // 5000 Coins per ETH   (changable)
        symbol          = "CSI";                         // Your Ticker Symbol  (changable)
        name            = "CS Token Demo";                    // Your Coin Name      (changable)
    }
